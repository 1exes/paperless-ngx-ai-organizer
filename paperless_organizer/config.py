...
ENABLE_KNOWLEDGE_EXTRACTION = os.getenv("ENABLE_KNOWLEDGE_EXTRACTION", "1").strip().lower() in ("1", "true", "yes", "on")
KNOWLEDGE_EXTRACTION_TIMEOUT = int(os.getenv("KNOWLEDGE_EXTRACTION_TIMEOUT", "30"))
KNOWLEDGE_EXTRACTION_MAX_TOKENS = int(os.getenv("KNOWLEDGE_EXTRACTION_MAX_TOKENS", "400"))
KNOWLEDGE_MIN_CONFIDENCE = float(os.getenv("KNOWLEDGE_MIN_CONFIDENCE", "0.4"))
KNOWLEDGE_PROMPT_MAX_LENGTH = int(os.getenv("KNOWLEDGE_PROMPT_MAX_LENGTH", "400"))
KNOWLEDGE_MAX_FACTS_IN_PROMPT = int(os.getenv("KNOWLEDGE_MAX_FACTS_IN_PROMPT", "12"))
